...
The recipe:
1. Go to [Cloudflare](https://dash.cloudflare.com/) and start setting up your domain. When you do, it will give you two NS servers to redirect your domain to. It's very important you do if _first_, because this will take 1-2 hours for every service to "get". In case of OVH, thesre is "DNS Servers" section in OVHcloud -- change it there, making sure you have DNSSEC disabled on the main domain page. All the steps below will happily throw random errors at you before DNS caches invalidate globally.
